...
func newServer() *gin.Engine {
	...
	router := gin.New()
	router.Use(New(WithCompressionType(DefaultCompression)))
...
func TestExcludedExtensions(t *testing.T) {
	...
	router := gin.New()
	router.Use(New(WithCompressionType(DefaultCompression), WithExcludedExtensions([]string{".html"})))
...
func TestExcludedPaths(t *testing.T) {
	...
	router := gin.New()
	router.Use(New(WithCompressionType(DefaultCompression), WithExcludedPaths([]string{"/api/"})))
...
func TestDecompressGzip(t *testing.T) {
	...
	router := gin.New()
	router.Use(New(WithCompressionType(DefaultCompression), WithDecompressFn(defaultDecompressHandle)))
